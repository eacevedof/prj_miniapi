...
*/  
    ...
    ["url"=>"/employees","controller"=>"App\Controllers\EmpleadosController","method"=>"index"],
    ["url"=>"/employees/","controller"=>"App\Controllers\EmpleadosController","method"=>"index"],
//Obtención del perfil de un empleado con el departamento, 
//cargo y salario actuales. Los campos a devolver son:    
    ["url"=>"/employees/profile","controller"=>"App\Controllers\EmpleadosController","method"=>"profile"],
    ["url"=>"/employees/profile/","controller"=>"App\Controllers\EmpleadosController","method"=>"profile"],
//Inserción de un empleado con los siguientes parámetros: 
    ["url"=>"/employees/insert","controller"=>"App\Controllers\EmpleadosController","method"=>"insert"],
    ["url"=>"/employees/insert/","controller"=>"App\Controllers\EmpleadosController","method"=>"insert"],
//para cargar selects
